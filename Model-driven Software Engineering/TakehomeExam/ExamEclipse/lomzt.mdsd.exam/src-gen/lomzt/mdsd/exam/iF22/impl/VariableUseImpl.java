 ...
 * </p>
 * <ul>
 *   <li>{@link lomzt.mdsd.exam.iF22.impl.VariableUseImpl#getRef <em>Ref</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VariableUseImpl extends ExpressionImpl implements VariableUse
{
  ...
  {
    return IF22Package.Literals.VARIABLE_USE;
  }
    ...
    if (ref != null && ref.eIsProxy())
    {
      ...
      if (ref != oldRef)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, IF22Package.VARIABLE_USE__REF, oldRef, ref));
      }
    }
    return ref;
  }
  ...
  public void setRef(Binding newRef)
  {
    ...
    ref = newRef;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, IF22Package.VARIABLE_USE__REF, oldRef, ref));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case IF22Package.VARIABLE_USE__REF:
