 ...
 * <!-- end-user-doc -->
 * @see dk.sdu.mmmi.mdsd.math.MathPackage#getMathNumberType()
 * @model
 * @generated
 */
public enum MathNumberType implements Enumerator
{
  /**
   ...
   * @generated
   */
  private static final MathNumberType[] VALUES_ARRAY =
    new MathNumberType[]
    {
      BYTE,
      SHORT,
   ...
   * @generated
   */
  public static final List<MathNumberType> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));
   ...
   * @generated
   */
  public static MathNumberType get(String literal)
  {
    for (int i = 0; i < VALUES_ARRAY.length; ++i)
    {
      MathNumberType result = VALUES_ARRAY[i];
   ...
   * @generated
   */
  public static MathNumberType getByName(String name)
  {
    for (int i = 0; i < VALUES_ARRAY.length; ++i)
    {
      MathNumberType result = VALUES_ARRAY[i];
   ...
   * @generated
   */
  public static MathNumberType get(int value)
  {
    switch (value)
    {
   ...
   * @generated
   */
  private MathNumberType(int value, String name, String literal)
  {
    this.value = value;
    this.name = name;
