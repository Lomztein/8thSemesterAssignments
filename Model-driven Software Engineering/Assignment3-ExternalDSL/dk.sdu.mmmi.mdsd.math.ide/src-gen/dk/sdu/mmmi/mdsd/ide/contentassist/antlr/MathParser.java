...
public class MathParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, MathGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getMathNumberTypeAccess().getAlternatives(), "rule__MathNumberType__Alternatives");
			...
			builder.put(grammarAccess.getExternalDefinitionAccess().getGroup_4(), "rule__ExternalDefinition__Group_4__0");
			...
			builder.put(grammarAccess.getExternalDefinitionAccess().getParamsAssignment_3(), "rule__ExternalDefinition__ParamsAssignment_3");
			builder.put(grammarAccess.getExternalDefinitionAccess().getParamsAssignment_4_1(), "rule__ExternalDefinition__ParamsAssignment_4_1");
			...
			builder.put(grammarAccess.getExternalCallAccess().getFuncAssignment_0(), "rule__ExternalCall__FuncAssignment_0");
			builder.put(grammarAccess.getExternalCallAccess().getArgsAssignment_2(), "rule__ExternalCall__ArgsAssignment_2");
			builder.put(grammarAccess.getExternalCallAccess().getArgsAssignment_3_1(), "rule__ExternalCall__ArgsAssignment_3_1");
