...
public class MathSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	 ...
	 *     PlusOrMinus.Plus_1_0_0_0 returns LetEnd
	 *     PlusOrMinus.Minus_1_0_1_0 returns LetEnd
	 *     MultOrDiv returns LetEnd
	 *     MultOrDiv.Mult_1_0_0_0 returns LetEnd
	 *     MultOrDiv.Div_1_0_1_0 returns LetEnd
	 *     Primary returns LetEnd
	 *     LetEnd returns LetEnd
	 *
	 * Constraint:
	 *     (name=ID exp=Exp in=Exp)
	 * </pre>
	 */
	protected void sequence_LetEnd(ISerializationContext context, LetEnd semanticObject) {
		...
		feeder.accept(grammarAccess.getLetEndAccess().getInExpParserRuleCall_5_0(), semanticObject.getIn());
		feeder.finish();
	}
	 ...
	 * <pre>
	 * Contexts:
	 *     Exp returns Litteral
	 *     PlusOrMinus returns Litteral
	 *     PlusOrMinus.Plus_1_0_0_0 returns Litteral
	 *     PlusOrMinus.Minus_1_0_1_0 returns Litteral
	 *     MultOrDiv returns Litteral
	 *     MultOrDiv.Mult_1_0_0_0 returns Litteral
	 *     MultOrDiv.Div_1_0_1_0 returns Litteral
