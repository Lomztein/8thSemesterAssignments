...
public interface MathPackage extends EPackage
{
   ...
   * @ordered
   */
  int LITTERAL__VALUE = EXP_FEATURE_COUNT + 0;
   ...
   * @ordered
   */
  int LITTERAL_FEATURE_COUNT = EXP_FEATURE_COUNT + 1;
   ...
   * @ordered
   */
  int LET_END__NAME = EXP_FEATURE_COUNT + 0;
   ...
   * @ordered
   */
  int LET_END__EXP = EXP_FEATURE_COUNT + 1;
   ...
   * @ordered
   */
  int LET_END__IN = EXP_FEATURE_COUNT + 2;
   ...
   * @ordered
   */
  int LET_END_FEATURE_COUNT = EXP_FEATURE_COUNT + 3;
